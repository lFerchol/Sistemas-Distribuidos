...
public class conexionDB {
    ...
    protected String pass_bd="ramirezj1";//Nombre de la contraseña a la BD
    
    //Modificar en caso de ser necesario
    protected String cc = "jdbc:postgresql://localhost:5432/" +Database+
                "?user=humberto&password="+pass_bd;//conexión completa
          ...
          try
            {
              ...
              Class.forName("org.postgresql.jdbc2");  //loads the driver
            }
            catch(ClassNotFoundException e)
            {
                    System.out.println("No encontró driver");
            }
            try
            {
                    ...
                    con = DriverManager.getConnection(url, "humberto", "ramirezj1");
    ...
    public Boolean Matricula_existe(String Matricula){
        Boolean existe=false;
